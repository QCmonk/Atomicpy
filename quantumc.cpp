...
static double __pyx_v_8quantumc_pi;
static double __pyx_v_8quantumc_rabi;
static double __pyx_v_8quantumc_phi;
static double __pyx_v_8quantumc_larmor;
...
static CYTHON_INLINE void __pyx_f_8quantumc_unitary22(double, __Pyx_memviewslice, __Pyx_memviewslice); /*proto*/
...
static const char __pyx_k_state_in[] = "state_in";
...
static PyObject *__pyx_pf_8quantumc_n_propagate(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_time, __Pyx_memviewslice __pyx_v_state_in, __Pyx_memviewslice __pyx_v_state_out); /* proto */
 ...
 * def n_propagate(double [:] time, complex [:] state_in, complex [:,:] state_out):             # <<<<<<<<<<<<<<
 *     # propagate a state vector forwards in time given an initial state, populating
 *     #state_out with the new states.
 */

/* Python wrapper */
static PyObject *__pyx_pw_8quantumc_1n_propagate(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_8quantumc_1n_propagate = {"n_propagate", (PyCFunction)__pyx_pw_8quantumc_1n_propagate, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_8quantumc_1n_propagate(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_time = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_state_in = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_state_out = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("n_propagate (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_time,&__pyx_n_s_state_in,&__pyx_n_s_state_out,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_state_in)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("n_propagate", 1, 3, 3, 1); __PYX_ERR(0, 27, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_state_out)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("n_propagate", 1, 3, 3, 2); __PYX_ERR(0, 27, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "n_propagate") < 0)) __PYX_ERR(0, 27, __pyx_L3_error)
      }
    ...
    __pyx_v_time = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_time.memview)) __PYX_ERR(0, 27, __pyx_L3_error)
    __pyx_v_state_in = __Pyx_PyObject_to_MemoryviewSlice_ds___pyx_t_double_complex(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_state_in.memview)) __PYX_ERR(0, 27, __pyx_L3_error)
    __pyx_v_state_out = __Pyx_PyObject_to_MemoryviewSlice_dsds___pyx_t_double_complex(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_state_out.memview)) __PYX_ERR(0, 27, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("n_propagate", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 27, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("quantumc.n_propagate", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_8quantumc_n_propagate(__pyx_self, __pyx_v_time, __pyx_v_state_in, __pyx_v_state_out);
...
static PyObject *__pyx_pf_8quantumc_n_propagate(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_time, __Pyx_memviewslice __pyx_v_state_in, __Pyx_memviewslice __pyx_v_state_out) {
  int __pyx_v_i;
  int __pyx_v_steps;
 ...
 *     state_out[0,:] = state_in
 * 
 */
  __pyx_t_1 = __Pyx_MemoryView_Len(__pyx_v_time); 
 ...
 */
  __pyx_t_2.data = __pyx_v_state_out.data;
  __pyx_t_2.memview = __pyx_v_state_out.memview;
...
__pyx_t_2.shape[0] = __pyx_v_state_out.shape[1];
__pyx_t_2.strides[0] = __pyx_v_state_out.strides[1];
    __pyx_t_2.suboffsets[0] = -1;

if (unlikely(__pyx_memoryview_copy_contents(__pyx_v_state_in, __pyx_t_2, 1, 1, 0) < 0)) __PYX_ERR(0, 34, __pyx_L1_error)
 ...
 *         unitary22(time[i], state_out[i-1,:], state_out[i,:])
 * 
 */
 ...
 */
    __pyx_t_6 = __pyx_v_i;
    __pyx_t_7.data = __pyx_v_state_out.data;
    __pyx_t_7.memview = __pyx_v_state_out.memview;
...
__pyx_t_7.shape[0] = __pyx_v_state_out.shape[1];
__pyx_t_7.strides[0] = __pyx_v_state_out.strides[1];
    __pyx_t_7.suboffsets[0] = -1;

__pyx_t_8.data = __pyx_v_state_out.data;
    __pyx_t_8.memview = __pyx_v_state_out.memview;
...
__pyx_t_8.shape[0] = __pyx_v_state_out.shape[1];
__pyx_t_8.strides[0] = __pyx_v_state_out.strides[1];
    __pyx_t_8.suboffsets[0] = -1;

__pyx_f_8quantumc_unitary22((*((double *) ( /* dim=0 */ (__pyx_v_time.data + __pyx_t_6 * __pyx_v_time.strides[0]) ))), __pyx_t_7, __pyx_t_8);
 ...
 */
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_v_state_in, 1);
 ...
 * cdef inline void unitary22(double t, complex [:] state_in, complex [:] state_out):             # <<<<<<<<<<<<<<
 *     # define a storage space for the magnetic field angles
 *     cdef double a = 0
 */

static CYTHON_INLINE void __pyx_f_8quantumc_unitary22(CYTHON_UNUSED double __pyx_v_t, __Pyx_memviewslice __pyx_v_state_in, __Pyx_memviewslice __pyx_v_state_out) {
  double __pyx_v_a;
  double __pyx_v_b;
  double __pyx_v_c;
  double __pyx_v_norm;
 ...
 *     E = sqrt(a*a + b*b)             # <<<<<<<<<<<<<<
 * 
 *     # compute unitary components
 */
  __pyx_v_E = sqrt(((__pyx_v_a * __pyx_v_a) + (__pyx_v_b * __pyx_v_b)));
 ...
 *     U11 = c + E             # <<<<<<<<<<<<<<
 *     U21 = a + 1j * b
 *     norm = sqrt(absquare(U11) + absquare(U21))
 */
  __pyx_v_U11 = __pyx_t_double_complex_from_parts((__pyx_v_c + __pyx_v_E), 0);
 ...
 *     U21 /= norm
 */
  __pyx_v_norm = sqrt((__pyx_f_8quantumc_absquare(__pyx_v_U11) + __pyx_f_8quantumc_absquare(__pyx_v_U21)));
 ...
 * 
 */
  __pyx_v_U11 = __Pyx_c_quot_double(__pyx_v_U11, __pyx_t_double_complex_from_parts(__pyx_v_norm, 0));
 ...
 *     U12 = c - E
 */
  __pyx_v_U21 = __Pyx_c_quot_double(__pyx_v_U21, __pyx_t_double_complex_from_parts(__pyx_v_norm, 0));
 ...
 *     U12 = c - E             # <<<<<<<<<<<<<<
 *     U22 = a + 1j * b
 *     norm = sqrt(absquare(U12) + absquare(U22))
 */
  __pyx_v_U12 = __pyx_t_double_complex_from_parts((__pyx_v_c - __pyx_v_E), 0);
 ...
 *     U12 /= norm
 */
  __pyx_v_U22 = __Pyx_c_sum_double(__pyx_t_double_complex_from_parts(__pyx_v_a, 0), __Pyx_c_prod_double(__pyx_t_double_complex_from_parts(0, 1.0), __pyx_t_double_complex_from_parts(__pyx_v_b, 0)));
 ...
 *     U22 /= norm
 */
  __pyx_v_norm = sqrt((__pyx_f_8quantumc_absquare(__pyx_v_U12) + __pyx_f_8quantumc_absquare(__pyx_v_U22)));
 ...
 * 
 */
  __pyx_v_U12 = __Pyx_c_quot_double(__pyx_v_U12, __pyx_t_double_complex_from_parts(__pyx_v_norm, 0));
 ...
 *     # output state
 */
  __pyx_v_U22 = __Pyx_c_quot_double(__pyx_v_U22, __pyx_t_double_complex_from_parts(__pyx_v_norm, 0));

  /* "quantumc.pyx":75
 * 
 *     # output state
 *     state_out[0] = U11*state_in[0] + U12*state_in[1]             # <<<<<<<<<<<<<<
 *     state_out[1] = U21*state_in[0] + U22*state_in[1]
 * 
 */
  __pyx_t_1 = 0;
  __pyx_t_2 = 1;
  __pyx_t_3 = 0;
  *((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_state_out.data + __pyx_t_3 * __pyx_v_state_out.strides[0]) )) = __Pyx_c_sum_double(__Pyx_c_prod_double(__pyx_v_U11, (*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_state_in.data + __pyx_t_1 * __pyx_v_state_in.strides[0]) )))), __Pyx_c_prod_double(__pyx_v_U12, (*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_state_in.data + __pyx_t_2 * __pyx_v_state_in.strides[0]) )))));
 ...
 */
  ...
  __pyx_t_5 = 1;
  __pyx_t_6 = 1;
  *((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_state_out.data + __pyx_t_6 * __pyx_v_state_out.strides[0]) )) = __Pyx_c_sum_double(__Pyx_c_prod_double(__pyx_v_U21, (*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_state_in.data + __pyx_t_4 * __pyx_v_state_in.strides[0]) )))), __Pyx_c_prod_double(__pyx_v_U22, (*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_state_in.data + __pyx_t_5 * __pyx_v_state_in.strides[0]) )))));
 ...
 * cdef inline void angles(double t, double *a, double *b, double *c):             # <<<<<<<<<<<<<<
 * 
 * 
 */

static CYTHON_INLINE void __pyx_f_8quantumc_angles(double __pyx_v_t, double *__pyx_v_a, double *__pyx_v_b, double *__pyx_v_c) {
  __Pyx_RefNannyDeclarations
 ...
 *     a[0] = rabi*cos(2*pi*larmor*t + phi)             # <<<<<<<<<<<<<<
 *     b[0] = 0.0
 *     c[0] = larmor
 */
  (__pyx_v_a[0]) = (__pyx_v_8quantumc_rabi * cos(((((2.0 * __pyx_v_8quantumc_pi) * __pyx_v_8quantumc_larmor) * __pyx_v_t) + __pyx_v_8quantumc_phi)));
 ...
 *     c[0] = larmor             # <<<<<<<<<<<<<<
 */
  (__pyx_v_c[0]) = __pyx_v_8quantumc_larmor;
 ...
 *     #state_out with the new states.
 */
  __pyx_tuple__22 = PyTuple_Pack(5, __pyx_n_s_time, __pyx_n_s_state_in, __pyx_n_s_state_out, __pyx_n_s_i, __pyx_n_s_steps); if (unlikely(!__pyx_tuple__22)) __PYX_ERR(0, 27, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__22);
  __Pyx_GIVEREF(__pyx_tuple__22);
  __pyx_codeobj__23 = (PyObject*)__Pyx_PyCode_New(3, 0, 5, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__22, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_quantumc_pyx, __pyx_n_s_n_propagate, 27, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__23)) __PYX_ERR(0, 27, __pyx_L1_error)
 ...
 * cdef double rabi = 1e4
 * cdef double phi = 0.0
 */
  __pyx_v_8quantumc_pi = 3.14159265358979323846;
 ...
 * cdef double rabi = 1e4             # <<<<<<<<<<<<<<
 * cdef double phi = 0.0
 * cdef double larmor = 7e5
 */
  __pyx_v_8quantumc_rabi = 1e4;
 ...
 *     #state_out with the new states.
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_8quantumc_1n_propagate, NULL, __pyx_n_s_quantumc); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 27, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_n_propagate, __pyx_t_1) < 0) __PYX_ERR(0, 27, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
